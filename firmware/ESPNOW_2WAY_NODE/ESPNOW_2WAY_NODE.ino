/**
   ESPNOW - Communication system
   GENERALIZE FIRMWARE FOR A SENSOR/ACTUATOR NODE
   This firmware sketch is meant as a starting point for creating custom sensor or actuator nodes.
   Depending on configuration of preprocessor flags, this firmware sends sensor data to a coordinator and/or accepts actuator signals from a coordinator.
...
//#define USE_ADXL313 // uncomment this line if using an ADXL313 low power 3 axis accelerometer
//#define VERBOSE // Uncomment to get verbose serial output
//#define COORDINATOR_AP // uncomment to find an AP-mode coordinator that is broadcasting a network ssid, otherwise find by mac address

#ifdef COORDINATOR_AP
const char* reciever_prefix = "rcv_"; // Set this to your AP coordinator's SSID prefix
#else
// Coordinator is STA mode. Set this to your coordinator's MAC address so that this node will be able to find it.
uint8_t recieverAddress[] = {0xE8, 0x9F, 0x6D, 0x2F, 0x64, 0x10}; // a
...
//const Trill::Device TRILL_DEVICE = Trill::TRILL_CRAFT;  // Set your Trill sensor type here
const Trill::Device TRILL_DEVICE = Trill::TRILL_FLEX;     // Set your Trill sensor type here
const Trill::Mode TRILL_MODE = Trill::CENTROID;           // Set your Trill sensor mode here (NOTE: Only CENTROID is supported in this firmware) 
//const Trill::Mode TRILL_MODE = Trill::DIFF;           // Set your Trill sensor mode here (NOTE: Only CENTROID is supported in this firmware) 
#endif
